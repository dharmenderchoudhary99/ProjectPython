...
# icons
imgae_icon = PhotoImage(file="icon.png")
root.iconphoto(False, imgae_icon)
...
send = Button(root, image=send_image, bg="#f4f5f6", bd=0, command=Send)
send.place(x=50, y=100)

receive_image = PhotoImage(file="receive.png")
receive = Button(root, image=receive_image, bg="#f4f5f6", bd=0, command=Receive)
