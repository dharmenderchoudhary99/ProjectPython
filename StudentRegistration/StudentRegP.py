...
#lets design automatic regsitration no. entry system
...
def Save():
    ...
    if N1=="" or C1=="Select Class" or D2=="" or Re1=="" or S1=="" or fathername=="" or mothername=="" or F1=="" or M1=="":
        ...
        messagebox.showinfo("info","Succee data Entered!!!")
...
def search():
    ...
    saveButton.config(state='disable') #On clicking on search no button will disable
    ...
    #reg_no_position showing like A1, A2,........,An
    # but reg_number showing number after A2 like 2, 3,........
    ...
    img=(Image.open("Students Images/"+str(x1)+".jpg")) #we have done this to take imaage
    resized_image=img.resize((190.190))
    photo2= ImageTk.PhotoImage(resized_image)
...
# top frames
Label(root, text="Email: xyz@gmail.com", width=10, height=3, bg="#f0687c", anchor='e').pack(side=TOP, fill=X)
Label(root, text="STUDENT REGISTRATION", width=10, height=2, bg="#c36464", fg="#fff", font='arial 20 bold').pack(
    side=TOP, fill=X)

# search box to upload
Search = StringVar()
...
Label(obj, text="DOB: ", font="arial 13", bg=framebg, fg=framefg).place(x=30, y=100)
...
Religion = StringVar()
relion_entry = Entry(obj, textvariable=Religion, width=20, font="arial 10")
relion_entry.place(x=630, y=100)
