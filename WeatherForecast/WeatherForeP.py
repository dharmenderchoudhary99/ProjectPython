...
def getWeather():
    ...
    api = "https://api.openweathermap.org/data/2.5/onecall?lat=" + str(location.latitude) + "&lon=" + str(
        location.longitude) + "&units=metric&exclude=hourly&appid={API key}"
    ...
    #days
    first=datetime.now()
    day1.config(text=first.strtfirst("%A"))

    second = first+timedelta(days=1)
    day2.config(text=second.strtfirst("%A"))

    third = first + timedelta(days=2)
    day3.config(text=third.strtfirst("%A"))

    fourth = first + timedelta(days=3)
    day4.config(text=fourth.strtfirst("%A"))

    fifth = first + timedelta(days=4)
    day5.config(text=fifth.strtfirst("%A"))

    sixth = first + timedelta(days=5)
    day6.config(text=sixth.strtfirst("%A"))

    seventh = first + timedelta(days=6)
    day7.config(text=seventh.strtfirst("%A"))
...
# thpwd
t = Label(root, text="temp", font=("Helvetics", 11), fg="white", bg="#203243")
t.place(x=150, y=120)

h = Label(root, text="temp", font=("Helvetics", 11), fg="white", bg="#203243")
h.place(x=150, y=140)

p = Label(root, text="temp", font=("Helvetics", 11), fg="white", bg="#203243")
p.place(x=150, y=160)

w = Label(root, text="temp", font=("Helvetics", 11), fg="white", bg="#203243")
w.place(x=150, y=180)

d = Label(root, text="temp", font=("Helvetics", 11), fg="white", bg="#203243")
d.place(x=150, y=200)
